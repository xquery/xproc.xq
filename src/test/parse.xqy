...
Congratulations! You've run your first pipeline!
	...
	<p:identity xproc:step="true" xproc:type="std-step">
	  <p:input port="source" select="/test" xproc:type="comp">
	    <p:inline xproc:type="comp">
	      <test xmlns="">test</test>
	    </p:inline>
	  </p:input>
	</p:identity>
	<p:count limit="20" xproc:step="true" xproc:type="std-step">
...
declare function  test:testExplicitName() { 
 let $pipeline := xdmp:document-get('file:///Users/jfuller/Source/Webcomposite/xprocxq_new/src/test/data/submit-test-report.xpl',<options xmlns="xdmp:document-get">
  ...
  return 
	...
	<p:documentation xproc:type="comp" xmlns="http://www.w3.org/1999/xhtml">
	  <div xproc:type="error"><p xproc:type="error"></p><p xproc:type="error"><code xproc:type="error"></code><code xproc:type="error"></code><code xproc:type="error"></code></p><p xproc:type="error"><code xproc:type="error"></code><a href="http://tests.xproc.org/" xproc:type="error"></a></p><p xproc:type="error"><code xproc:type="error"></code><code xproc:type="error"></code><a href="http://tests.xproc.org/" xproc:type="error"></a></p></div>
	</p:documentation>
...
Congratulations! You've run your first pipeline!
	...
	<p:group xproc:step="true" xproc:type="comp-step" xproc:default-name="!1.1">
	  <p:identity xproc:step="true" xproc:type="std-step" xproc:default-name="!1.1.1"></p:identity>
	</p:group>
	...
	<p:count limit="20" xproc:step="true" xproc:type="std-step" xproc:default-name="!1.3">
	  <p:with-option xproc:type="comp" name="limit" select="20"></p:with-option>
	</p:count>
      </p:declare-step>
) 
...
Congratulations! You've run your first pipeline!
	...
	<p:group xproc:step="true" xproc:type="comp-step" xproc:default-name="!1.1">
	  <ext:pre xproc:default-name="!1.1.0" xproc:step="true">
	    <p:input xproc:type="comp" port="source" primary="true" select="/"/>
	    <p:output xproc:type="comp" port="result" primary="true" select="/"></p:output>
	  </ext:pre>
...
declare function  test:testExplicitBindings1() { 
  ...
  return 
	...
	<ext:pre xproc:default-name="!1.0" xproc:step="true" xmlns:ext="http://xproc.net/xproc/ext" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:err="http://www.w3.org/ns/xproc-error" xmlns:xxq-error="http://xproc.net/xproc/error">
...
Congratulations! You've run your first pipeline!
	...
	<p:identity xproc:step="true" xproc:type="std-step" xproc:default-name="!1.1" xmlns:ext="http://xproc.net/xproc/ext" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:err="http://www.w3.org/ns/xproc-error" xmlns:xxq-error="http://xproc.net/xproc/error">
	  <p:input port="source" select="/" xproc:type="comp" primary="true">
...
declare function  test:testExplicitBindings2() { 
  ...
  return 
	...
	<ext:pre xproc:default-name="!1.0" xproc:step="true" xmlns:ext="http://xproc.net/xproc/ext" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:err="http://www.w3.org/ns/xproc-error" xmlns:xxq-error="http://xproc.net/xproc/error" xmlns:cx="http://xmlcalabash.com/ns/extensions">
	  <p:input port="source" select="/" xproc:type="comp" primary="true">
	...
	<p:string-replace match="uri/text()" name="patch-test-uris" xproc:step="true" xproc:type="std-step" xproc:default-name="!1.1" xmlns:ext="http://xproc.net/xproc/ext" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:err="http://www.w3.org/ns/xproc-error" xmlns:xxq-error="http://xproc.net/xproc/error" xmlns:cx="http://xmlcalabash.com/ns/extensions">
	  <p:input port="source" select="/" xproc:type="comp" primary="true">
	    <p:inline xproc:type="comp">
	...
	<p:identity name="extract-uri" xproc:step="true" xproc:type="std-step" xproc:default-name="!1.2" xmlns:ext="http://xproc.net/xproc/ext" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:err="http://www.w3.org/ns/xproc-error" xmlns:xxq-error="http://xproc.net/xproc/error" xmlns:cx="http://xmlcalabash.com/ns/extensions">
	...
	<p:choose xproc:step="true" xproc:type="comp-step" xproc:default-name="!1.3" xmlns:ext="http://xproc.net/xproc/ext" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:err="http://www.w3.org/ns/xproc-error" xmlns:xxq-error="http://xproc.net/xproc/error" xmlns:cx="http://xmlcalabash.com/ns/extensions"></p:choose>
	<p:exec command="/projects/src/calabash/generate-test-report" xproc:step="true" xproc:type="opt-step" xproc:default-name="!1.4" xmlns:ext="http://xproc.net/xproc/ext" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:err="http://www.w3.org/ns/xproc-error" xmlns:xxq-error="http://xproc.net/xproc/error" xmlns:cx="http://xmlcalabash.com/ns/extensions">
	  <p:input port="source" select="/" xproc:type="comp" primary="true">
	    <p:empty xproc:type="comp"></p:empty>
	  </p:input>
	  <p:output xproc:type="comp" port="result" primary="true" select="/"></p:output>
	...
	<p:choose xproc:step="true" xproc:type="comp-step" xproc:default-name="!1.5" xmlns:ext="http://xproc.net/xproc/ext" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:err="http://www.w3.org/ns/xproc-error" xmlns:xxq-error="http://xproc.net/xproc/error" xmlns:cx="http://xmlcalabash.com/ns/extensions"></p:choose>
      </p:declare-step>) 
};
...
Congratulations! You've run your first pipeline!
	...
	<p:group xproc:step="true" xproc:type="comp-step" xproc:default-name="!1.1" xmlns:ext="http://xproc.net/xproc/ext" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:err="http://www.w3.org/ns/xproc-error" xmlns:xxq-error="http://xproc.net/xproc/error"></p:group>
	<p:identity xproc:step="true" xproc:type="std-step" xproc:default-name="!1.2" xmlns:ext="http://xproc.net/xproc/ext" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:err="http://www.w3.org/ns/xproc-error" xmlns:xxq-error="http://xproc.net/xproc/error">
	...
	<p:count limit="20" xproc:step="true" xproc:type="std-step" xproc:default-name="!1.3" xmlns:ext="http://xproc.net/xproc/ext" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:err="http://www.w3.org/ns/xproc-error" xmlns:xxq-error="http://xproc.net/xproc/error">
	  <p:input port="source" select="/" xproc:type="comp" primary="true">
...
declare function  test:testExplicitBindings4() { 
  ...
  return 
	...
	<p:identity name="step1" xproc:step="true" xproc:type="std-step" xproc:default-name="!1.1" xmlns:ext="http://xproc.net/xproc/ext" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:err="http://www.w3.org/ns/xproc-error" xmlns:xxq-error="http://xproc.net/xproc/error">
	  <p:input port="source" select="/" xproc:type="comp" primary="true">
	    <p:pipe port="result" xproc:type="comp" step="!1.0" xproc:step-name="!1.0"></p:pipe>
	  </p:input>
	  <p:output xproc:type="comp" port="result" sequence="true" primary="true" select="/"></p:output>
	</p:identity>
	<p:identity name="step3" xproc:step="true" xproc:type="std-step" xproc:default-name="!1.2" xmlns:ext="http://xproc.net/xproc/ext" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:err="http://www.w3.org/ns/xproc-error" xmlns:xxq-error="http://xproc.net/xproc/error">
	  <p:input port="source" select="/" xproc:type="comp" primary="true">
	    <p:pipe port="result" xproc:type="comp" step="!1.3" xproc:step-name="!1.3"></p:pipe>
	  </p:input>
	  <p:output xproc:type="comp" port="result" sequence="true" primary="true" select="/"></p:output>
	</p:identity>
	<p:count limit="20" name="step2" xproc:step="true" xproc:type="std-step" xproc:default-name="!1.3" xmlns:ext="http://xproc.net/xproc/ext" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:err="http://www.w3.org/ns/xproc-error" xmlns:xxq-error="http://xproc.net/xproc/error">
	  <p:input port="source" select="/" xproc:type="comp" primary="true">
	    <p:pipe port="result" xproc:type="comp" step="!1.1" xproc:step-name="!1.1"></p:pipe>
	  </p:input>
	  <p:output xproc:type="comp" port="result" primary="true" select="/"></p:output>
...
declare function  test:testStepSort() { 
 ...
 let $b          := $parse/*
 let $expected := <go> <ext:pre xproc:default-name="!1.0" xproc:step="true" xmlns:ext="http://xproc.net/xproc/ext" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:err="http://www.w3.org/ns/xproc-error" xmlns:xxq-error="http://xproc.net/xproc/error" xmlns:xproc="http://xproc.net/xproc">
	...
	<p:output xproc:type="comp" port="result" primary="true" select="/" xmlns:p="http://www.w3.org/ns/xproc"></p:output>
      ...
      <p:identity name="step1" xproc:step="true" xproc:type="std-step" xproc:default-name="!1.1" xmlns:ext="http://xproc.net/xproc/ext" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:err="http://www.w3.org/ns/xproc-error" xmlns:xxq-error="http://xproc.net/xproc/error" xmlns:p="http://www.w3.org/ns/xproc" xmlns:xproc="http://xproc.net/xproc">
	<p:input port="source" select="/" xproc:type="comp" primary="true">
	  <p:pipe port="result" xproc:type="comp" step="!1.0" xproc:step-name="!1.0"></p:pipe>
	</p:input>
	<p:output xproc:type="comp" port="result" sequence="true" primary="true" select="/"></p:output>
      </p:identity>
      <p:count limit="20" name="step2" xproc:step="true" xproc:type="std-step" xproc:default-name="!1.3" xmlns:ext="http://xproc.net/xproc/ext" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:err="http://www.w3.org/ns/xproc-error" xmlns:xxq-error="http://xproc.net/xproc/error" xmlns:p="http://www.w3.org/ns/xproc" xmlns:xproc="http://xproc.net/xproc">
	<p:input port="source" select="/" xproc:type="comp" primary="true">
	  <p:pipe port="result" xproc:type="comp" step="!1.1" xproc:step-name="!1.1"></p:pipe>
	</p:input>
	<p:output xproc:type="comp" port="result" primary="true" select="/"></p:output>
	<p:with-option xproc:type="comp" name="limit" select="20"></p:with-option>
      ...
      <p:identity name="step3" xproc:step="true" xproc:type="std-step" xproc:default-name="!1.2" xmlns:ext="http://xproc.net/xproc/ext" xmlns:c="http://www.w3.org/ns/xproc-step" xmlns:err="http://www.w3.org/ns/xproc-error" xmlns:xxq-error="http://xproc.net/xproc/error" xmlns:p="http://www.w3.org/ns/xproc" xmlns:xproc="http://xproc.net/xproc">
	<p:input port="source" select="/" xproc:type="comp" primary="true">
	  <p:pipe port="result" xproc:type="comp" step="!1.3" xproc:step-name="!1.3"></p:pipe>
	</p:input>
	<p:output xproc:type="comp" port="result" sequence="true" primary="true" select="/"></p:output>
      </p:identity>
      <ext:post xproc:step="true" xproc:default-name="!1!" xmlns:ext="http://xproc.net/xproc/ext" xmlns:xproc="http://xproc.net/xproc">
...
<p:identity/>
  ...
  return 
	...
	<p:group xproc:step="true" xproc:type="comp-step" xproc:default-name="!1.1">
	  <ext:pre xproc:default-name="!1.1.0" xproc:step="true" xmlns:ext="http://xproc.net/xproc/ext">
	    <p:input xproc:type="comp" port="source" primary="true" select="/"></p:input>
	    <p:output xproc:type="comp" port="result" primary="true" select="/"></p:output>
	  </ext:pre>
	  <p:identity xproc:step="true" xproc:type="std-step" xproc:default-name="!1.1.1">
	    <p:input xproc:type="comp" port="source" sequence="true" primary="true" select="/"></p:input>
	    <p:output xproc:type="comp" port="result" sequence="true" primary="true" select="/"></p:output>
	  </p:identity>
	  <p:count xproc:step="true" xproc:type="std-step" xproc:default-name="!1.1.2">
	    <p:input xproc:type="comp" port="source" primary="true" sequence="true" select="/"></p:input>
	    <p:output xproc:type="comp" port="result" primary="true" select="/"></p:output>
