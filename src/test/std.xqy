...
declare function  test:testIdentity() { 
  let $actual := std:identity(<test/>,(),(),())
  return
    assert:equal($actual,<test xmlns=""></test>)
};

declare function  test:testCount() { 
...
declare function  test:testCount2() { 
...
declare function  test:testCount3() { 
  let $input  := (<test/>,<test/>,<test/>,<test/>)
...
declare function  test:testCount4() { 
  let $input  := (<test/>,<test/>,<test/>,<test/>)
