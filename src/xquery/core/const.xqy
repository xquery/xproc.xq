...
(: -------------------------------------------------------------------------- :)
declare variable $const:error :=  u:document-get("lib/xprocv2/etc/error-codes.xml");
declare variable  $const:xprocxq-error  := u:document-get("lib/xprocv2/etc/xproc-error-codes.xml");

(: -------------------------------------------------------------------------- :)
(:~ Step Definition lookup :) (:~ @TODO - obviously need to remove these absolute paths :)
(: -------------------------------------------------------------------------- :)
declare variable $const:ext-steps  := ();
declare variable $const:std-steps  := ();
declare variable $const:opt-steps  := ();
declare variable $const:comp-steps := ();

(: -------------------------------------------------------------------------- :)
(:~ System Property :)
(: -------------------------------------------------------------------------- :)
declare variable $const:version :="2.0";
...
declare variable $const:xpath-version :="3.0";
